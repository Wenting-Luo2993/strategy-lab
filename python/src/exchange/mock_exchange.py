...
class MockExchange(Exchange):
    ...
    def __init__(
        ...
        self.force_fill = force_fill  # If True, all orders are treated as immediate fills
    ...
    def enable_force_fill(self, enabled: bool = True) -> None:
    ...
    def _process_force_fill(self, order: Order, current_price: float) -> OrderResponse:
        ...
        # Remove order since fully filled
